...
const andPattern =
  /\s*,?\s+and\s+(?!different card names\b|(?:Leader|Character|Event|Stage)s? effects\b|your opponent's Life cards\b|set it as active\b|rest them\b|\+\d+\s+(?:cost|power)\b|place them at the top(?: or bottom)?\b)/iu;
