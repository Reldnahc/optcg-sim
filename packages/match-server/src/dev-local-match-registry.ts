...
import {
  ...
  sessionTokenForSubject,
  syncActiveSessionPlayerLabels,
} from "./dev-local-match-registry-seat-helpers.js";
import type {
...
export { matchSeatsWithMatchId } from "./dev-local-match-registry-seat-helpers.js";
