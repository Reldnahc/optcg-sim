      ...
      effects: [
        {
          ...
          effect: { type: "custom", handler: "unsupported-permanent" },
        },
      ],
    },
  };
      ...
      effects: [
        {
          ...
          sourcePresencePolicy: "mustRemainInSameZone",
          effect: { type: "custom", handler: "unsupported-stage-activation" },
        },
      ],
    },
  };
      ...
      effects: [
        {
          ...
          trigger: { type: "onPlay" },
          effect: { type: "custom", handler: "unsupported-stage-on-play" },
        },
      ],
    },
  };
        ...
        effects: [
          {
            ...
            effect: {
              type: "custom",
              handler: `${category}-wrapped-unsupported-on-play`,
            },
          },
        ],
      },
