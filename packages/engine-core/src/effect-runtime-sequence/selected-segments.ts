...
import { applyTrashToDeckBottomSelectedCardMoveSegment } from "./selected-trash-to-deck.js";
...
export const applySelectedCardMoveSegment = (
  ...
  if (
    ...
    return applyLifeToDeckBottomSelectedCardMoveSegment(params, selected);
  }
  if (
...
export { applySelectedHandDeckPlacementDecisionResponse } from "./selected-hand-deck-placement-response.js";
