<!-- agent-packet:story-id ENG-033A -->
<!-- agent-packet:story-path stories/approved/ENG-033A-split-baseline-real-state-visibility-tests.yaml -->
<!-- agent-packet:story-sha256 18389e36118ca75409d23a4d7cd5f1d8dfce7b842f459535b7dcced443dd607d -->
...
ID: ENG-033A
Epic ID: KICK-001
Title: Split baseline real-state visibility tests
Type: refactor
Area: engine
...
Move baseline real-state PlayerView visibility assertions out of filter-state-for-player.real-states.test.ts into a focused baseline test file without changing filtering behavior, legal-action projection, hidden-info policy, fixtures, assertions, or expected outputs.
...
Own only behavior-preserving test-file organization for the non-battle samples inside the existing mixed "real engine states stay hidden-info safe across phase and battle progression" test in filter-state-for-player.real-states.test.ts. This story moves setup-boot, mulligan, main-phase, after-card-play, stage-present, face-up-life, completed-match, and public-zone real-state visibility coverage only.

## Scope

- split the existing mixed phase-and-battle real-state test and move only its setup-boot, mulligan, main-phase, after-card-play, stage-present, face-up-life, completed-match, and public-zone assertions from filter-state-for-player.real-states.test.ts
- leave the after-attack-damage and after-blocker samples in filter-state-for-player.real-states.test.ts for ENG-033B
- preserve hidden-information assertions, public-zone expectations, legal-action projection checks, helper behavior, and expected PlayerView output
...
- moving battle, trigger, K.O., no-zone, revealed-card, or target-selection real-state coverage
...
- stories/generated/ENG-033A-split-baseline-real-state-visibility-tests.yaml
- stories/approved/ENG-033A-split-baseline-real-state-visibility-tests.yaml
- agent-packets/ENG-033A.md
- agent-packets/active.json

## Constraints

- story-review must pass before moving this story to approved or implementing
- generate and activate only the ENG-033A packet while implementing this story
...
- run corepack pnpm exec vitest run packages/engine-core/src/filter-state-for-player.real-states.test.ts packages/engine-core/src/filter-state-for-player.real-states-baseline.test.ts
...
- filter-state-for-player.real-states.test.ts no longer contains the moved baseline scenario group
- filter-state-for-player.real-states-baseline.test.ts covers the same baseline real-state visibility scenarios with behavior-equivalent expectations
