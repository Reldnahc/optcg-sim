<!-- agent-packet:story-id ENG-032E -->
<!-- agent-packet:story-path stories/approved/ENG-032E-split-banish-damage-tests.yaml -->
<!-- agent-packet:story-sha256 0ac11b4276f84190d09c52762d8f5c883422ed972d83728050bc8eb450e009c5 -->
...
ID: ENG-032E
Epic ID: KICK-001
Title: Split Banish damage tests
Type: refactor
Area: engine
...
Move existing Banish-specific damage tests out of battle-damage-banish.test.ts into a focused Banish damage test file without changing assertions, fixtures, events, state hashes, or behavior.
...
Own only behavior-preserving test-file organization for Banish Life-to-trash, trigger suppression, and Banish fail-closed coverage currently in battle-damage-banish.test.ts.

## Scope

- move Banish Leader damage Life-to-trash and deterministic reindexing coverage from battle-damage-banish.test.ts
- move Banish public/private cardMoved event visibility coverage from battle-damage-banish.test.ts
- move Banish trigger suppression coverage from battle-damage-banish.test.ts
- move Banish pending runtime, replacement metadata, and fail-closed coverage from battle-damage-banish.test.ts
- move the Banish-specific unsupported blocker metadata fail-closed case as Banish damage coverage, without moving general Blocker tests
- preserve state hash, event visibility, and mutation expectations

## Out of Scope

- changing production code
- changing Banish, Life Trigger, runtime, replacement, or event visibility behavior
- moving vanilla damage, Character K.O., On K.O., Life Trigger response, general Blocker, Counter, attack timing, or pipeline regression tests

## Allowed Touch Points

<!-- prettier-ignore -->
- packages/engine-core/src/battle-damage-banish.test.ts
- packages/engine-core/src/battle-damage-banish-only.test.ts
- stories/generated/ENG-032E-split-banish-damage-tests.yaml
- stories/approved/ENG-032E-split-banish-damage-tests.yaml
- agent-packets/ENG-032E.md
- agent-packets/active.json

## Constraints

- story-review must pass before moving this story to approved or implementing
- generate and activate only the ENG-032E packet while implementing this story
...
- run corepack pnpm exec vitest run packages/engine-core/src/battle-damage-banish.test.ts packages/engine-core/src/battle-damage-vanilla.test.ts packages/engine-core/src/battle-damage-banish-only.test.ts
...
- battle-damage-banish.test.ts no longer contains the moved Banish-specific test groups
- battle-damage-banish-only.test.ts covers the same Banish scenarios with behavior-equivalent expectations
