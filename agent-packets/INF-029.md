<!-- agent-packet:story-id INF-029 -->
<!-- agent-packet:story-path stories/approved/INF-029-repair-cleanup-packet-command.yaml -->
<!-- agent-packet:story-sha256 291db7df45d5729d32884be56d330582097cf35de7116428caa770ecc207d05e -->
...
Repair the post-merge cleanup executor command construction so the workflow invokes packet completion without passing an extra literal separator argument to `tools/build-agent-packet.ts`.
...
Own the cleanup executor command invocation bug and the exact INF-028 manual packet-cleanup fallback required because automation failed after preflight. Do not redesign cleanup metadata, branch protection, packet lifecycle semantics, or workflow authorization.
