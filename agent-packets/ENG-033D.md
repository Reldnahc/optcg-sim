<!-- agent-packet:story-id ENG-033D -->
<!-- agent-packet:story-path stories/approved/ENG-033D-split-target-selection-real-state-visibility-tests.yaml -->
<!-- agent-packet:story-sha256 67fe9cada8884b09c0e368892a9f7151f14bd476fd7ef61799414ef8287089bf -->
...
ID: ENG-033D
Epic ID: KICK-001
Title: Split target-selection real-state visibility tests
Type: refactor
Area: engine
...
Move selectTargets real-state PlayerView visibility and legal-action assertions out of filter-state-for-player.real-states.test.ts into a focused target-selection visibility test file without changing filtering behavior, hidden-info policy, fixtures, assertions, or expected outputs.
...
Own only behavior-preserving test-file organization for selectTargets real-state PlayerView visibility and legal-action projection coverage currently in filter-state-for-player.real-states.test.ts.

## Scope

- move selectTargets real-state visibility and legal-action assertions from filter-state-for-player.real-states.test.ts
- preserve candidate hiding, legal response hiding, private queue metadata hiding, legal-action projection checks, helper behavior, and expected PlayerView output
- keep helper extraction local to the moved tests unless the story implementation needs local duplicated helpers to preserve behavior
...
- moving baseline, battle, trigger, no-zone, On K.O., or revealed-card real-state coverage
...
- stories/generated/ENG-033D-split-target-selection-real-state-visibility-tests.yaml
- stories/approved/ENG-033D-split-target-selection-real-state-visibility-tests.yaml
- agent-packets/ENG-033D.md
- agent-packets/active.json

## Constraints

- story-review must pass before moving this story to approved or implementing
- generate and activate only the ENG-033D packet while implementing this story
...
- run corepack pnpm exec vitest run packages/engine-core/src/filter-state-for-player.real-states.test.ts packages/engine-core/src/filter-state-for-player.real-states-baseline.test.ts packages/engine-core/src/filter-state-for-player.real-states-battle.test.ts packages/engine-core/src/filter-state-for-player.real-states-triggers.test.ts packages/engine-core/src/filter-state-for-player.real-states-targeting.test.ts
...
- filter-state-for-player.real-states.test.ts no longer contains the moved selectTargets scenario group
- filter-state-for-player.real-states-targeting.test.ts covers the same selectTargets real-state visibility scenarios with behavior-equivalent expectations
