...
| ENG-055J | `agent-story-review-ENG-055J-feasibility-rereview3-choose-2026-05-16` | approval-ready  | Story now includes `choose` by requiring `selectTargets` pause/resume and a durable exact-card continuous-effect target carrier until expiry. | None beyond implementation cautions in the story artifact.                                                                          |
...
- ENG-055J is approval-ready with `choose` in scope after the third-pass review.
