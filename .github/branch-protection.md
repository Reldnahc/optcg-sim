...
- Implementation worker subagents use gpt-5.4 medium or gpt-5.3-codex medium.
- Reviewer subagents always use gpt-5.4 high.
- Simple mechanical stories should prefer gpt-5.3-codex medium.
- Broader or riskier integration stories should prefer gpt-5.4 medium.
