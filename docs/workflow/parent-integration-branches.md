...
- Direct cleanup commits are allowed only for exact packet-completion command output after repo verification passes; automation-created cleanup pull requests are not created.
